...
cd base && docker build \
  ...
  --build-arg QGIS_VERSION=3.40.11 \
  --build-arg OTB_VERSION=9.1.1 \
...
1. Derived from [`nvidia/cuda:13.0.1-base-ubuntu24.04`](https://hub.docker.com/r/nvidia/cuda/tags?page=1&name=13.0.1-base-ubuntu24.04)
