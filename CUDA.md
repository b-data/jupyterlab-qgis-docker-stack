...
cd base && docker build \
  ...
  --build-arg QGIS_VERSION=3.34.11 \
...
1. Derived from [`nvidia/cuda:12.6.2-runtime-ubuntu22.04`](https://hub.docker.com/r/nvidia/cuda/tags?page=1&name=12.6.2-runtime-ubuntu22.04)
