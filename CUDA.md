...
docker build \
  ...
  --build-arg QGIS_VERSION=3.44.13 \
...
1. Derived from [`nvidia/cuda:13.3.1-base-ubuntu24.04`](https://hub.docker.com/r/nvidia/cuda/tags?page=1&name=13.3.1-base-ubuntu24.04)
